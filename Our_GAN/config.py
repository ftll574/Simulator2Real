...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--no_instance',action='store_true',help='default use instance, else no use.')
    ...
    if train:
        ...
        parser.add_argument('--lambda_DiffAugPA', type=float, default=0.005, help='probabilistic attenuation decay rate')
    else:
